...
const UpdateProduct = () => {
  const { product, loading: loading1 } = useSelector(
  ...
  // Inititally Load the previous Data
  useEffect(() => {
    fetchProductDetails();
  }, [product._id, id]);
...
"
                ...
                <div className="px-4 text-center">
                  <button
                    className="outline-none  text-center p-3 px-4 hover:bg-violet-500 active:bg-violet-500 shadow-sm rounded bg-violet-800 text-white "
                    type="submit"
